    ...
    <div id="content">
        ...
        <div class="right-pnel">
            <form name="myform" method="post"
                  action="<?= base_url() ?>/index.php/dhamakapackage/saveDhamakaPackage" class="form validate-form animated fadeIn">
                <fieldset>
                    <legend>Dhamaka Package</legend>
                    <div class="feildwrap">
                    ...
                    <div>
                        <br>
                        <input type="submit" class="btn" style="float: right;" value="Add Dhamaka Package">
                    </div>
                </fieldset>
            </form>
        </div>
...
//                "<td class='tbl-price'><input type='text' name='BySeaPrice[]' style='width: 99px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Price' placeholder='Price'></td>" +
