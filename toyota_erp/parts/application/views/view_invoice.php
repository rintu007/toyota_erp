...
//                                $count = 1;
                                ...
                                foreach ($AllUrgentOrders as $UrgentOrders) {
                                    ...
                                    <tr id="UrgentOrders">
                                        ...
                                        <td class="tbl-imc"><?= $UrgentOrders['IMCRemarks'] ?></td>
										 <td><a href="<?= base_url() ?>index.php/invoices/PrintUrgentOrder/<?= $UrgentOrders['OrderNumber'] ?>">Print</a> </td>
                 ...
                 <!-- Chemical Orders List -->
                            ...
                            <tbody id="finalResult">
                                ...
                                foreach ($AllChemicalOrder as $chemicalOrders) {
                                    ...
                                    <tr id="LPOrders">
                                        ...
                                        <!--<td><a href="<?= base_url() ?>index.php/invoices/dailyorder/<?= $DailyOrders['OrderNumber'] ?>">Get Invoice</a> </td>-->
                                        <?php
                                        //echo anchor(base_url() . 'index.php/adduser/delete/' . $UserId, 'Delete', array('onClick' => "return confirm('Are you sure you want to delete?')"));
                                        ?>
                                        <!--</td>-->
                  ...
                  <!-- Monthly Orders List -->
                    <div class="btn-block-wrap dg">
                        <table width="100%" border="0" cellpadding="1" cellspacing="1" class="monthlyorder" style="display: none" >
                            <thead>
                                <tr>
                                    <th width="10%">Date</th>
                                    <th width="10%">Order Reason</th>
                                    <th width="10%">Part Number</th>
                                     <th width="10%">Description</th>
                                    <th width="10%">Qty in Stock</th>
                                    <th width="10%">Unit Price</th>
                                    <th width="15%">MAD</th>
                                    <th width="05%">Month 1</th>
                                    <!--<th width="05%">Month 2</th>
                                    <th width="05%">Month 3</th>-->
                                    <th width="5%">QTY 1</th>
									<!--<th width="5%">QTY 2</th>
                                    <th width="5%">QTY 3</th>-->
                                    <th width="5%">Brand Code</th>
                                    <th width="5%">Print</th>
                            ...
                            <tbody id="finalResult">
                                <?php
                                foreach ($MonthlyOrderCycle as $MonthlyOrder) {
							
                                    ?>
                                    <tr id="LPOrders">
                                        <td class="tbl-date"><?= $MonthlyOrder['CreatedDate'] ?></td>
                                        <td class="tbl-date"><?= $MonthlyOrder['OrderReason'] ?></td>
                                        <td class="tbl-order"><?= $MonthlyOrder['PartNumber'] ?></td>
                                        <td class="tbl-order"><?= $MonthlyOrder['PartName'] ?></td>
                                        <td class="tbl-part"><?= $MonthlyOrder['QuantityInStock'] ?></td>
                                        <td class="tbl-part"><?= $MonthlyOrder['UnitPrice'] ?></td>
                                        <td class = "tbl-part"><?= $MonthlyOrder['MAD'] ?></td>
                                        <td class="tbl-desc"><?= date('F', strtotime("2012-".$MonthlyOrder['month1']."-01")); ?></td>
                                       <!--<td class="tbl-qty"><?= date('F', strtotime("2012-".$MonthlyOrder['month2']."-01")); ?></td>
                                        <td class="tbl-dispatch"><?=  date('F', strtotime("2012-".$MonthlyOrder['month3']."-01")); ?></td>-->
                                        <td class="tbl-dealer"><?= $MonthlyOrder['Quantity1'] ?></td>
                                        <!--<td class="tbl-imc"><?= $MonthlyOrder['Quantity2'] ?></td>
                                        <td class="tbl-imc"><?= $MonthlyOrder['Quantity3'] ?></td>-->
                                        <td class="tbl-imc"><?= $MonthlyOrder['BrandCode'] ?></td>
                                        <td><a href="<?= base_url() ?>index.php/invoices/PrintMonthlyOrder/<?= $MonthlyOrder['id'] ?>/<?=$MonthlyOrder['month1']?>">Print</a> </td>

                                        <!--<td><a href="<?= base_url() ?>index.php/invoices/dailyorder/<?= $DailyOrders['id'] ?>">Get Invoice</a> </td>-->
                                        <?php 
                                        //echo anchor(base_url() . 'index.php/adduser/delete/' . $UserId, 'Delete', array('onClick' => "return confirm('Are you sure you want to delete?')"));
                                        ?>
                                        <!--</td>-->
...
<script>
    ...
    $(".invoiceType").change(function() {
        ...
        else if ($(".invoiceType").val() === 'MONTHLY ORDER CYCLE') {
             $(".monthlyorder").show();
            $(".chemicalOrder").hide();
            $(".byseaorderOrder").hide();
            $(".vorOrder").hide();
