        ...
        <div class="right-pnel">
            ...
            <div id="searchform" class="feildwrap">
                <div class="btn-block-wrap datagrid" id="shwcompat">
                    <a href="<?=base_url()?>index.php/Documentreceive/from_sales_request"><button class="btn" type="button">ADD Document Request</button></a>
                    <table id="allcomplaints" width="100%" border="0" cellpadding="1" cellspacing="0">
                        ...
                        <?php
                        $count = 1;
                        foreach($documentRequests as $val) { ?>
                            <tr>
                                <td><?=$count++;?></td>
                                <td><?=$val['type']?></td>
                                <td><?=$val['ChasisNo']?></td>
