    ...
    <div class="row-fluid">
        <div class="span12 text-center">
            ...
            <input type="button" value="Print Preview" class="btn-info" onClick="PrintPreview()"/>
             <a href="http://192.168.1.195/parts/index.php/invoices/PrintSpecialPackageexcel/<?=$OrderNo?>">  <input type="button" value="Excel Sheet" class="btn-info" /></a>
        </div>
    </div>
</div>
<br/>
<div id="printArea">
    ...
    <div class="container border" style="width: 948px;">
        ...
        <div class="full-grid text-center gray-bg"><h4>Special ORDER</h4></div>
        ...
        <div class="row">
            <div class="span12 text-center bold underline">
                <span class="" style="font-size: 24px;">Special ORDER</span>
            </div>
        </div>
        <br/>
        <br/>
                    ...
                    <table class="table">
                       <thead>
                        ...
                        <tr>
                            ...
                            <th align="center">Special Price</th>
                            <th align="center">Package Date</th>
                        ...
                        foreach ($GetInvoice as $GetInvoices) {
                            ...
                            <tr>
                                ...
                                <td><?=$GetInvoices['SpecialPrice']?></td>
                                <td><?=$GetInvoices['PackageDate']?></td>
