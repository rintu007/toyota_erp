    ...
    <div class="row-fluid">
        <div class="span12 text-center">
            ...
            <input type="button" value="Print Preview" class="btn-info" onClick="PrintPreview()"/>
             <a href="http://192.168.1.195/parts/index.php/invoices/PrintChemicalPackageexcel/<?=$OrderNo?>">  <input type="button" value="Excel Sheet" class="btn-info" /></a>
        </div>
    </div>
</div>
<br/>
<div id="printArea">
    ...
    <div class="container border" style="width: 948px;">
        ...
        <div class="full-grid text-center gray-bg"><h4>Toyota Chemical Package</h4></div>
        ...
        <div class="row">
            <div class="span12 text-center bold underline">
                <span class="" style="font-size: 24px;">Toyota Chemical Package</span>
            </div>
        </div>
        <br/>
        <br/>
