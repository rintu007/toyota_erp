...
//                        
                    ...
                    <div>
                        <table id="do" title="Other Purchase" style="width:auto;height:auto;"
                               url="<?= base_url() ?>/index.php/invoices/searchotherpurchase/" toolbar="#toolbar" pagination="true" idField="OrderNumber"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Other Purchase' ?>',required:true}}">Part Number</th>
...
<script>
    ...
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/OtherPurchase/allOtherPurchase',
        saveUrl: '<?= base_url() ?>/index.php/OtherPurchase/saveOtherPurchase',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/OtherPurchase/delete',
        ...
        $.each(row, function (index, value) {
            if (value) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/OtherPurchase/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
