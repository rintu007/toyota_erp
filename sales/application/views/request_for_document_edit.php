    ...
    <div id="content">
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/requestfordocument/update" class="form validate-form animated fadeIn">
                 ...
                 <div id="searchform" class="feildwrap">
                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <textarea name="document_tx" placeholder="Documents.." ><?php echo $testDrivedetail['document_tx']; ?></textarea>   
                        </div>
                        <div>
                        ...
                        <div>
                            <label>Order Form No</label>
								   ...
								   <input type="text" name="order_form_no" id="searchnow" value="<?php echo $testDrivedetail['order_form_no']; ?>"
                                   > 
                        </div>
                        <div>
                        ...
                        <div>
                            <label>Applicant</label>
								   ...
								   <input type="text" name="application" id="searchnow" value="<?php echo $testDrivedetail['application']; ?>">    
                        ...
                        <div>
                            ...
                            <select name="saleman">
							<option><?php echo $testDrivedetail['Username']; ?></option>
                            <?php
                        ...
                        <div>
                            <label>Invoice No</label>
								   ...
								   <input type="text" name="invoice_no" id="searchnow" value="<?php echo $testDrivedetail['invoice_no']; ?>"> 
                        </div>
                        <div>
...
<input style="margin: 12px 0 0 0;" type="checkbox" class="input_control"  name="no_plate" value="1" <?=$testDrivedetail['no_plate'] == 1 ? 'checked':''?>/>							
						   ...
						   <input style="margin: 12px 0 0 0;" type="checkbox" class="input_control"  name="d_saleman" value="1"  <?=$testDrivedetail['d_saleman'] == 1 ? 'checked' :''?>/> 
                        </div>
