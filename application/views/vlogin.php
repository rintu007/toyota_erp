                            ...
                            <form name="myform" onSubmit="return validationform()" method="post"
                                ...
                                <fieldset>
                                    ...
                                    <div class="feildwrap">
										...
										<br>
                                        <div>
                                            <label style="width:auto !important;padding:none !important;text-align:left !important;">UserName</label><br>
                                            <input type="text" name="username" data-validation="required"  style="width: 250px;">
                                        </div>
                                        <br>

                                        <div>
                                            <label style="width:auto !important;padding:none !important;text-align:left !important;">Password</label><br>
