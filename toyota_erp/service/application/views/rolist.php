                                ...
                                <tbody id="rolistbody">
                                    ...
                                    foreach ($roDetails as $key) {
                                        ...
                                        <tr id="allcomplaints">
                                            ...
                                            <td name="" class="tbl-name"><a  style="cursor: pointer" onclick="getValues(<?php echo $key['idRO'] ?>);">Check</a></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?= base_url() ?>index.php/rolist/searchRODetailDate",
            type: "POST",
                ...
                if (data !== "null")
                {
                    ...
                    if (a.length > 0) {
                        try {
                            ...
                            <td class='tbl-name'><a style='cursor: pointer' onClick=getValues('" + val.idRO + "')>Check</a></td></tr>";
                            });
...
//                "<td class='tbl-price'><input type='text' name='PartsDescription[]' style='width: 192px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='PartsDescription' placeholder='Description'></td>" +
...
//                "<td class='tbl-price'><input type='text' name='PartsSign[]' style='width: 50px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='PartsSign' placeholder='Signature'></td>" +
//                "</tr>";
//        $('#tblParts').append(items);
//        $("select[name='PartNumber[]']").chosen({no_results_text: "Oops, nothing found!"});
//        //        $('.cb-error').click(function() {
//        //            $(this).hide();
//        //        });
//
//    });
...
//    var SubletTotal = 0;
    ...
    $("#searchbyro").keyup(function() {
        ...
        $.ajax({
            url: "<?= base_url() ?>index.php/rolist/searchRODetail",
            type: "POST",
            data: {searchbyro: search},
            success: function(data) {
                if (data !== "null")
