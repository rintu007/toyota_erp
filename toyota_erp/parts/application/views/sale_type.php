...
//        }
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/sales/type" class="form validate-form animated fadeIn">
                <fieldset>
                    <legend>Add Sale Type</legend>
                    <div class="feildwrap">
                        <div>
                        ...
                        <div class="btn-block-wrap">
                            <label>&nbsp;</label>
                            <input type="submit" class="btn" value="Add Sale Type">
                        </div>
                    </div>
                </fieldset>
            </form>
            <form method="post" class="form animated fadeIn" onsubmit="return false">
                <fieldset>
                    <legend>Sale Type List</legend>
                    <div class="feildwrap">
                        <div>
                            <label>Search Sale Type</label>
                    ...
                    <div class="btn-block-wrap dg">
                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tbody id="finalResult">
                                <?php
                                $count = 1;
                                foreach ($SaleType as $AllTypes) {
                                    $idSaleType = $AllTypes['idSaleType'];
                                    ?>
                                    <tr id="carUsers">
                                        <td class="resId" name="resId"><?= $count++ ?></td>
                                        <td class="tbl-name"><?= $AllTypes['SaleType'] ?></td>
                                        <td><a style="cursor: pointer;" onClick="SalePopup('detail', '<?= $idSaleType ?>', '<?= $AllTypes['SaleType'] ?>')">Edit</a>
                                            <?php
