...
if ($data['userid'] != "") {
    ...
    <html>
        <head>
            <meta charset="utf-8">
            <title>Customer Relations - Toyota Faislabad Motors</title>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(".cb-error").hide();
                    $("#shwmobilnum").mask('9999-9999999', {placeholder: '#'});//03112004603
                    $("#showphonenum").mask('999-99999999', {placeholder: '#'});
                    $('.Timepicker').timepicker();
                });
                $(".Timepicker").mask('99:99:99', {placeholder: '0'});//12:12:30 (Fax Number)

                //            $("#shwmobilnum").mask('9999-9999999', {placeholder: '#'});//03112004603
                //            $("#showphonenum").mask('999-99999999', {placeholder: '#'});//02134915889
