                ...
                <div class="feildwrap" id="divtblallcomplaints">
                    ...
                    <fieldset>
                        ...
                        if ($allcomplaints == null) {
                            ?>
                            <div><label><b>No Complaints to Give FeedBack</b></label></div>
                        <?php } else { ?>
                            <br><div id="searchform" class="feildwrap">
                                <div>
                                    <label>Search</label>
...
//            var value = elem.parentElement.parentElement.childNodes[1].innerHTML;
    ...
    $('#searchnow').keyup(function() {
        ...
        $.ajax({
            url: "<?= base_url() ?>index.php/Message/servicefilteredcomplaintmessage",
            type: "POST",
