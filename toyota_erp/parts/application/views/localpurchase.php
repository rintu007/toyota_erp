    ...
    <div id="content">
        ...
        <div class="right-pnel">
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>/index.php/localpackage/saveLocalPurchase" class="form validate-form animated fadeIn">
                <fieldset>
                    ...
                    <div>
                        <br>
                        <input type="submit" class="btn" style="float: right;" value="Add Local Purchase">
                    </div>
                </fieldset>
            </form>
        </div>
...
<script>
	...
	var length = $(".tblPurchaseLocal").length+1;
        ...
        items += "<tr class='tblPurchaseLocal'><td class='tbl-count'>"+length+"</td><td class='tbl-part'><select onchange=getPart(this) class='chosen-select' name='idPart[]' style='background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='PartNumber'><option>Select Part Number</option><?php
                ...
                "<td class='tbl-price'><input type='text' name='UnitPrice[]' class='unit' style='width: 70px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Price' placeholder='Unit Price'></td>" +
                "<td class='tbl-price'><input type='text' name='TotalPrice[]' class='total' style='width: 70px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Price' placeholder='Total Price'></td>" +
