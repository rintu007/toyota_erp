<div id="wrapper">
    <div id="content">
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" action="<?= base_url() ?>index.php/deliveryorder/insert_do" method="post"
                ...
                <div id="searchform" class="feildwrap">
                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="text" class="date" name="entrydate" value=""  data-validation="required">
                        </div>
                        <div>
<!--                            --><?php //print_r($dispatchdata)?>
                        ...
                        <div>
                            <label>Sold to</label>
                            <input type="text" class=""  name="soldto" value="" >
                        </div>

                        <div>
                            <label>Care of</label>
                            <input type="text" class="" name="careof" value="" >
                        </div>
...
<!--                            <a href="--><?//=site_url("index.php/dispatch/dispatchReceive_list")?><!--">Back</a>-->
                        ...
                        <div>
                         ...
                         <div>
                            <label>Driver</label>
                            <input name="driver" type="text" value="" data-validation="required" id="">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="code_sub_account" id="">
                                ...
                                <?php foreach ($sub_account as $row){?>
                                    <option value="<?=$row['code_sub_account']?>"> <?=$row['sub_account']?> </option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="checkbox" name="FFSFollowup" id="FFSFollowup">
                            <input type="date" name="FFSFollowupdate" id="FFSFollowupdate" value="">
                        </div>
                        <div>
                            <label for="">
                                Clear Delivery Order
                                <input type="checkbox" name="cashdeliveryorder">
                            </label>
                            <label for="">
                                Receive do in Finance
                                <input type="checkbox" name="receivedoinfinance">
                            </label>
                            <label for="">
                                Loyalty Card Offer
                                <input type="checkbox" name="loyaltycardoffer">
                            </label>
                            <label for="">
                                Resale
