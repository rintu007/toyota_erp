    ...
    <div id="content">
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/documentreceive/sales_request_update" class="form validate-form animated fadeIn">
                <div id="searchform" class="feildwrap">
                    ...
                    <fieldset>
                        ...
                        <fieldset>
                            ...
                            if($row['status']!='RECEIVED') {
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" <?=$row['status']=='DISPATCHED'?'checked':'' ?> class="docs" name="iddocument[]" value="<?=$row['iddocument']?>" id="doc_<?=$row['iddocument']?>" />
                                </div>
                        ...
                        <br>
                        <div >
                            <input type="submit" value="Dispatch" class="btn" >
                        </div>
