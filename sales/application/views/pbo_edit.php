...
<div id="wrapper">
    <div id="content">
        <form action="<?= base_url() ?>/index.php/pbo/updatePBO" onsubmit="return validationform()" enctype="multipart/form-data" method="post" class="form pbo-form fadeIn">
            <?php
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="efPayOrder" name="payOrderNo" value="<?php echo $PBODetails['PayorderNumber']; ?>" style="margin-left: 10px;"/>
                                        </td>
                                    </tr>
<!--                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="BankName" id="efBankName" value="<?php echo $PBODetails['BankName']; ?>"/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="BankCity" id="efBankCity" value="<?php echo $PBODetails['BankCity']; ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="Filer" id="FIler" checked="true" value="Filer" <?php echo ($PBODetails['FIType'] == "Filer" ? 'checked' : ''); ?> />
                                        </td>
                                        <td>
                                            <label>Non Filer</label>
                                        </td>
                                        <td>
                                            <input type="radio" name="Filer" id="NonFiler"  value="Non Filer" <?php echo ($PBODetails['FIType'] == "Non Filer" ? 'checked' : ''); ?> />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td colspan="4">
                                            <input type="text" id="fiPayOrder" name="PO"  value="<?php echo $PBODetails['PboSerialNumber']; ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="fiBankName" id="fiBankName"  value="<?php echo $PBODetails['FIBankName']; ?>"/>
                                        </td>
                                        <td>
                                            <label>Bank Branch</label>
                                        </td>
                                        <td>
                                            <input type="text" id="fiBankBranch" name="fiBankBranch"  value="<?php echo $PBODetails['FIBankBranch']; ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="fiBankCity" id="fiBankCity"  value="<?php echo $PBODetails['FIBankCity']; ?>"/>
                                        </td>
                                    </tr>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="PurchaseOrder"  value="<?php echo $PBODetails['PurchaseOrderNumber']; ?>" />
                                        </td>
                                        <td>
                                            <label>Date</label>
                                        </td>
                                        <td>
                                            <input type="text" class="date" name="PurchaseDate"  value="<?php echo $PBODetails['PurchaseDate']; ?>" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
