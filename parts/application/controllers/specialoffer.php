...
*/
    ...
    public function report() {
        if (isset($_POST['pdf'])) {
            ...
            if ($Filter == "All") {
                $Data = $Reporting->SpecialOfferReport(NULL, NULL);
            } else if ($Filter == "OrderNumber") {
                if ($OrderNumber != "") {
                    $Data = $Reporting->SpecialOfferReport($OrderNumber, NULL);
                }
            } else {
                if ($Brand != "Select Brand") {
                    $Data = $Reporting->SpecialOfferReport(NULL, $Brand);
                }
            }
//            $pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
            ...
            $pdf->SetTitle('Special Offer Reports');
            $pdf->SetSubject('');
            $pdf->SetKeywords('Special Offer Report');

            //set default header data
//        $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING, array(0, 64, 255), array(0, 64, 128));
            $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Parts Division', "Special Offer Report");
            ...
            <thead>
                <tr>
                    ...
                    <td width="150" height="30" style="line-height: 30px;" align="center" colspan="2"><b>Special Price</b></td>
            ...
            <tbody>';
                ...
                <tr>
                    ...
                    <td width="150" height="30" style="line-height: 30px;" align = "center" colspan="2">' . $allData['SpecialPrice'] . '</td>
            ...
            <thead>
                <tr>
                    ...
                    <td width="130" height="30" style="line-height: 30px;" align="center" colspan="2"><b>Special Price</b></td>
            ...
            <tbody>';
                ...
                <tr>
                    ...
                    <td width="130" height="30" style="line-height: 30px;" align = "center" colspan="2">' . $allData['SpecialPrice'] . '</td>
...
//        echo json_encode($fillPartCombo);
    ...
    function allSpecialOffers() {
        $invoice = new Parts_invoices();
        $DailyOrder = $invoice->allSpecialOffers();
        echo json_encode($DailyOrder);
    }

    function saveSpecialOffer() {
        $invoice = new Parts_invoices();
        $savePlanOrder = $invoice->saveSpecialOffer();
        redirect(base_url() . "/index.php/Specialoffer/index");
    }

    function delete() {
        $invoice = new Parts_invoices();
        $idOrderNumber = $invoice->oneSpecialOffer($_POST["id"])[0];
        if (!empty($idOrderNumber)) {
            $deleteDailyOrder = $invoice->deleteSpecialOffer($idOrderNumber["idOrderNumber"]);
            if ($deleteDailyOrder) {
    ...
    function orderNumber() {
        $invoice = new Parts_invoices();
        $orderNumber = $invoice->getOrderNumber($invoice->getAccessoriesOrderCode()[0]);
        return $orderNumber;
    }
