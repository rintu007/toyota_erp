...
class Parking extends CI_Controller {
    ...
    public function index() {
        ...
        $config['num_links'] = 1;
        $config["base_url"] = base_url() . "index.php/parking/index";
        $config["total_rows"] = $this->Car_parking->record_count();
        $config["per_page"] = 10;
        ...
        $this->data["Location"] = $this->Car_parking->allLocation( $config["per_page"], $page);

        $this->data["counts"] = $this->Car_parking->record_count();

        $this->data["links"] = $this->pagination->create_links();
        $this->data['message'] = $this->session->flashdata('message');
       // $Data = array();
       // $Location = new Car_parking();
    ...
    function addlocation() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            redirect(base_url() . "index.php/parking/index");
        }
    }
...
public function delete($id) {
      $LocationId=$id;
        $result = $this->Car_parking->delete($LocationId);
		  redirect(base_url() . "index.php/parking/index");
    }
