...
//                        
                    ...
                    <div>
                        <table id="do" title="Local Purchase" style="width:auto;height:auto;"
                               url="<?= base_url() ?>/index.php/invoices/searchLocalPurchase/" toolbar="#toolbar" pagination="true" idField="OrderNumber"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Local Purchase' ?>',required:true}}">Part Number</th>
                                    ...
                                    <th field="UnitPrice" width="50" editor="{type:'validatebox',options:{required:false}}">Unit Price</th>
...
<script>
    ...
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/LocalPurchase/allLocalPurchase',
        saveUrl: '<?= base_url() ?>/index.php/LocalPurchase/saveLocalPurchase',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/LocalPurchase/delete',
        ...
        $.each(row, function (index, value) {
            if (value) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/localpurchase/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
