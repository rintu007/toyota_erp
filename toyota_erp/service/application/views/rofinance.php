            ...
            <form id="RoFinanceForm" action="<?= base_url() ?>index.php/rofinance/Update"  method="post" onSubmit="" class="form animated fadeIn">
                ...
                <fieldset>
                    ...
                    <div id="" class="feildwrap" style="float: left">
                        ...
                        <div>
                            <div style="margin-left: 50px"><input id="" name="type" type="radio"  value="Cash" checked="">Cash</div>
                            <div style="margin-left: 50px"><input id="" name="type" type="radio"  value="Credit" checked="">Credit</div>
...
<script>
                ...
                success: function(data) {
                    if (data !== "null")
                    {
                        ...
                        if (parsedData.length > 0) {
                            try {
                                ROMode = parsedData[0]['ROMode']
                                Bptype = parsedData[0]['BPType']
                        ...
                        try {
                            ...
                            if($("#checkboxdiv input:checkbox:checked").length > 0){
                                var gst_html =  '<div style="display: block; page-break-before: always;clear:both;" ></div>' +
                                    ...
                                    ' <p style="text-transform: capitalize;"><b style="font-size:15px"><strong>TYPE OF JOB <span style="padding-left:7%"> :</span> </strong></b><strong> '+result['ModeName']+'</strong></p>' +
                                    ...
                                    '<p>  </p></td><td> </td></tr>' +
                                    ' <tr> <td style="padding-left:25px;font-size:20px"><strong>PARTS</strong><span style="padding-left:73%">' +
                                    ...
                                    '<strong>Rs. '+parseFloat(result['PartsAmount']).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> SST 0% </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>0</strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ...
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>Rs. '+parseFloat(result['PartsAmount']*1).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    ' </tbody></table> ' +
                                    '<!-- <br/><br/><br/><br/><br/> ' +
                                    ...
                                    ' </div> ' +
                                    '</div>'+
                                    '<div style="display: block; page-break-before: always;clear:both;" ></div>' +
                                    '<div class="container" style="border-align:center">' +
                                    ...
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>TOTAL AMOUNT </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>Rs. '+parseFloat(result['LabourAmount']).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> SST '+result['GSTax']+' %</em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>'+((result['LabourAmount']*result['GSTax'])/100)+' </strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>NET TOTAL AMOUNT </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>Rs. '+parseFloat((result['LabourAmount']*1)+((result['LabourAmount']*result['GSTax'])/100)).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    ' </tbody></table> ' +
                                    '<!-- <br/><br/><br/><br/><br/> ' +
                                    '<p align="center" style="font-size:15px">' +
                            ...
                            var html = '<div class="container" style="border-align:center">' +
                                ...
                                '<br> Karachi, Pakistan<br> UAN: 021-111-800-777 Tel: 021-32590184,32564531 / 2564532 Fax: 9221-2564536' +
                                '<br> E-mail: customer.relations@toyotawestern.com/service@toyotawestern.com<br> parts@toyotawestern.com </strong> </p> </td> </tr> ' +
                                '<tr> <td style="border-top:1px solid black;border-bottom:none;">' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px">CUSTOMER NAME : </b> '+result['CustomerName']+'</span><br>' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px">COMPANY NAME <span style="padding-left:10%"> : </span> </b> '+result['CompanyName']+'</span><br>' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px">ADDRESS <span style="padding-left:13%"> : </span> </b> '+result['AddressDetails']+'</span><br>' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px">PHONE NO. <span style="padding-left:10%"> :</span> </b>'+result['Cellphone']+'</span><br>' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px">NTN. <span style="padding-left:18%"> :</span> </b>'+result['Ntn']+'</span><br>' +
                                ' <span style="text-transform: capitalize;"><b style="font-size:15px"><strong>TYPE OF JOB <span style="padding-left:7%"> :</span> </strong></b><strong> '+result['ModeName']+'</strong></p>' +
                                ' </td> </tr> </tbody></table> </div>' +
                                ' <br> ' +
                                '<div class="description" style="width:100%;margin-left:20px;align:center;">' +
                                ' <p></p><p></p><p></p><p></p><p></p>' +
                                ...
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>TOTAL AMOUNT </em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                '<strong>Rs. '+parseFloat(parseFloat(result.PartsAmount) +parseFloat(result.LabourAmount)+parseFloat(result.SubletRepairAmount)).toFixed(2)+'</strong></td> ' +
                                '</tr>' +
                                '<tr>' +
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> SST '+result['GSTax']+'%</em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                '<strong>RS '+parseFloat((result['LabourAmount']*result['GSTax'])/100).toFixed(2)+' </strong></td> ' +
                                '</tr>' +
                                '<tr>' +
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>NET TOTAL AMOUNT </em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                            ...
                            popupWin.document.write('<html><title>::Invoice Preview::</title><link rel=Stylesheet href=<?php echo base_url(); ?>assets/invoice/style.css><body onload="window.print()">');
    ...
    function checkAndReceivePayment() {
        ...
        $roData['type'] = $("input[name='type']:checked").val();
        $roData['ROMode'] = ROMode;
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data !== "")
                {
                    ...
                    if (ROMode === "Warranty") {
                        ...
                        location.reload()
                        //   location.reload();
                    } else if (Bptype === "Insurance") {
                        var RROnumber =     $('#RONumber').val();
                        depriciationBill(RROnumber);
                        //   location.reload();
                    }else if (data === "Payment Received") {
                        var RROnumber =     $('#RONumber').val();
                        PrintDoc(RROnumber);
                        //   location.reload();
                    } else {
    ...
    function depriciationBill(ROnumber) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data !== "null")
                {
                    ...
                    if (parsedData['getRoData'].length > 0) {
                        try {
                            Dep = parsedData['getRoData'][0]['DepAmountPercent']
                            var parts_html = '';
                            var parts = (parsedData['Parts'])?parsedData['Parts']:[];
                            for(i=0;i<parts.length;i++){
                                parts_html += '<tr> <td style="float:left;padding-left:30px">'+(parseInt(i)+1)+'.</td> ' +
                            ...
                            var parts_Customer = '';
                            var parts_Customer_total = 0
                            var parts_Ins = '';
                            var parts_Ins_total = 0
                            var amount =0

                            parts_Customer = parts_Ins = parts_html
//                            for(i=0;i<parts.length;i++){
//                                 amount = parseInt(parts[i]['PartAmount']);
//                                parts_Customer += '<tr> <td style="float:left;padding-left:30px">'+(parseInt(i)+1)+'.</td> ' +
//                                    '<td style="float:left;padding-left:2px">'+parts[i]['PartName']+'</td> ' +
//                                    '<td>'+parts[i]['PartQuantity']+'</td> ' +
//                                    '<td>Rs '+parseFloat(parts[i]['PartAmount']).toFixed(2)+'</td>' +
//                                    '<td>'+(amount - ((amount/100))*parseInt(Dep)).toFixed(2)+'</td> ' +
//                                    ' </tr>' ;
//                                parts_Customer_total+=(amount - ((amount/100))*parseInt(Dep))
//                            }
...
//                            for(i=0;i<parts.length;i++){
//                                 amount = parseInt(parts[i]['PartAmount']);
//                                parts_Ins += '<tr> <td style="float:left;padding-left:30px">'+(parseInt(i)+1)+'.</td> ' +
//                                    '<td style="float:left;padding-left:2px">'+parts[i]['PartName']+'</td> ' +
//                                    '<td>'+parts[i]['PartQuantity']+'</td> ' +
//                                    '<td>Rs '+parseFloat(parts[i]['PartAmount']).toFixed(2)+'</td> ' +
//                                    '<td>'+(amount - ((amount/100))*(100 - parseInt(Dep))).toFixed(2)+'</td> ' +
//                                    '</tr>' ;
//                                parts_Ins_total+= (amount - ((amount/100))*(100 - parseInt(Dep)))
//
//                            }
                            ...
                            var gst_html=''
                            if($("#checkboxdiv input:checkbox:checked").length > 0){
                                gst_html =  '<div style="display: block; page-break-before: always;clear:both;" ></div>' +
                                    '<div class="container" style="border-align:center">' +
                                    ' <table class="header"> ' +
                                    '<tbody>' +
                                    '<tr> ' +
                                    ...
                                    '<br> E-mail: customer.relations@toyotawestern.com/service@toyotawestern.com<br> parts@toyotawestern.com </strong> </p> </td> </tr> ' +
                                    '<tr> <td style="border-top:1px solid black;border-bottom:none;">' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">INSURANCE COMPANY :</b>'+result['insuranceCompany']+'</span><br>' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">Address <span style="padding-left:18%"> :</span> </b>'+result['BranchName']+' '+result['insuranceAddress']+'</span><br>' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">Loss Number <span style="padding-left:11%"> :</span> </b>'+result['LossNumber']+'</span><br>' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">Policy Number <span style="padding-left:11%"> :</span> </b>'+result['PolicyNumber']+'</span><br>' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">NTN <span style="padding-left:2%"> :</span> </b>'+result['insNTN']+'</span>&nbsp;&nbsp;' +
                                    ' <span style="text-transform: capitalize;"><b style="font-size:15px">GST <span style="padding-left:2%"> :</span> </b>'+result['insGST']+'</span><br>' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> Deprciation'+ (100-Dep)+'% </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>'+( ((result['PartsAmount']*1)/100)*(100-Dep) ).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>NET TOTAL AMOUNT </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>Rs. '+( ((result['PartsAmount']*1)/100)*(100-Dep) ).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    ' </tbody></table> ' +
                                    '<!-- <br/><br/><br/><br/><br/> ' +
                                    '<p align="center" style="font-size:15px">' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> Depriciation '+ Dep+'% </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>'+( ((result['PartsAmount']*1)/100)*(Dep) ).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    '<tr>' +
                                    ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>NET TOTAL AMOUNT </em></strong></td> ' +
                                    '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                    '<strong>Rs. '+( ((result['PartsAmount']*1)/100)*(Dep) ).toFixed(2)+'</strong></td> ' +
                                    '</tr>' +
                                    ' </tbody></table> ' +
                                    '<!-- <br/><br/><br/><br/><br/> ' +
                                    '<p align="center" style="font-size:15px">' +
                            ...
                            var html =
                                ...
                                ' <tr>' +
                                ' <td style="text-align:right" colspan="2"><strong>PARTS </strong></td> ' +
                                '<td style="width:20%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">Rs. '+( ((result['PartsAmount']*1)/100)*(100-Dep) ).toFixed(2)+'</td>' +
                                ' </tr> ' +
                                ' <tr>' +
                                ...
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>TOTAL AMOUNT </em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                '<strong>Rs. '+parseFloat(parseFloat( ((result['PartsAmount']*1)/100)*(100-Dep)  ) +parseFloat(result.LabourAmount)+parseFloat(result.SubletRepairAmount)).toFixed(2)+'</strong></td> ' +
                                '</tr>' +
                                '<tr>' +
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em> SST '+result['GSTax']+'%</em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                ...
                                ' <td style="text-align:right;font-size:20px" colspan="2"><strong><em>NET TOTAL AMOUNT </em></strong></td> ' +
                                '<td style="width:20%;height:50%;border:1px solid black;border-left:2px solid black;border-right:2px solid black;text-align:right;padding-right:10px;">' +
                                '<strong>Rs. '+ parseFloat((parseFloat( ((result['PartsAmount']*1)/100)*(100-Dep)  ) +parseFloat(result.LabourAmount)+parseFloat(result.SubletRepairAmount))+ parseFloat((result['LabourAmount']*result['GSTax'])/100)).toFixed(2)+'</strong></td> ' +
//                                '<strong>Rs. '+parseFloat(result['NetTotal']).toFixed(2)+'</strong></td> ' +
                                '</tr>' +
                                ' </tbody></table> ' +
                                '<!-- <br/><br/><br/><br/><br/> ' +
