    ...
    <div id="content">
        ...
        <div class="right-pnel">
            <form name="myform" method="post"
                  action="<?= base_url() ?>/index.php/Specialoffer/saveSpecialOffer" class="form validate-form animated fadeIn">
                <fieldset>
                            ...
                            <table id='LocalTable' name='LocalTable' width="100%" border="0" cellpadding="1" cellspacing="1">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="5%" >PartName</th>
                                        <th width="8%" >Qty</th>
                                        <th width="12%">Special Price</th>
                                        <th width="12%">Total</th>
                                        <th width="12%">Package Date</th>
                    ...
                    <div>
                        <br>
                        <input type="submit" class="btn" style="float: right;" value="Add Special Offer">
                    </div>
                </fieldset>
            </form>
        </div>
...
<script>
	...
	var unit = $(this).val();
	$(this).parent().parent().find('.total').val(unit*qty);
	//alert(qty*unit);
});
	...
	var length = $(".tblPurchaseLocal").length+1;
        ...
        items += "<tr class='tblPurchaseLocal'><td class='tbl-count'>"+length+"</td><td class='tbl-part'><select onchange=getPart(this) class='chosen-select' name='idPart[]' style='background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='PartNumber'><option>Select Part Number</option><?php
                ...
                "<td class='tbl-quantity'><input type='text' name='Quantity[]' class='qty' style='width: 69%;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Quantity' placeholder='Qty'></td>" +
                "<td class='tbl-price'><input type='text' name='SpecialPrice[]' class='unit' style='width: 70px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Price' placeholder='Unit Price'></td>" +
                "<td class='tbl-price'><input type='text' name='Total[]' class='total' style='width: 70px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Total' placeholder='Total'></td>" +
                "<td class='tbl-price'><input type='text' class='date hasDatepicker' name='PackageDate[]' style='width: 70px;background: #fff; padding: 7px 4px 7px 7px; border: 1px solid #dfdfdf; padding: 7px 10px; -webkit-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09); box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.09);' id='Price' placeholder='Package Date'></td>" +
