...
">-->
                    ...
                    <div class="feildwrap">
                        <div class="btn-block-wrap">
                            <div>
                                ...
                                $OrderNum = $cookieData['Code'] . "/" . $OrderType['Code'] . $this->session->userdata("BrandCode") . "/" . $month_only;
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <table id="do" title="Daily Orders" style="width:auto;height:auto;"
                               url="<?= base_url() ?>/index.php/invoices/searchdailyorder/" toolbar="#toolbar" pagination="true" idField="OrderNumber"
                               rownumbers="true" fitColumns="true" multiSelect="true" scrollbarSize="11">
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Daily Order' ?>',required:true}}">Part Number</th>
