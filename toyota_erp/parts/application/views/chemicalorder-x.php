...
//                        
                    ...
                    <div>
                        <table id="do" title="Chemical Order" style="width:auto;height:auto;"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Chemical Order' ?>',required:true}}">Part Number</th>
...
<script>
    ...
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/ChemicalOrder/allChemicalOrder',
        saveUrl: '<?= base_url() ?>/index.php/ChemicalOrder/saveChemicalOrder',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/ChemicalOrder/delete',
        ...
        $.each(row, function (index, value) {
            if (value) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/chemicalorder/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
