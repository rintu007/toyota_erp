    ...
    <div class="row-fluid">
        <div class="span12 text-center">
            ...
            <input type="button" value="Print Preview" class="btn-info" onClick="PrintPreview()"/>
             <a href="http://192.168.1.195/parts/index.php/invoices/PrintPlanPackageexcel/<?=$OrderNo?>">  <input type="button" value="Excel Sheet" class="btn-info" /></a>
...
<div id="printArea">
    ...
    <div class="container border" style="width: 948px;">
        ...
        <div class="full-grid text-center gray-bg"><h4>Toyota Plan Package</h4></div>
        ...
        <div class="row">
            <div class="span12 text-center bold underline">
                <span class="" style="font-size: 24px;">Toyota Plan Package</span>
            </div>
        </div>
        <br/>
        <br/>
                    ...
                    <table class="table">
                        ...
                        foreach ($GetInvoice as $GetInvoices) {
                            ...
                            <tr>
                                ...
                                <td><?=$GetInvoices['WSPrice']?></td>
                                <td><?=$GetInvoices['TotalPrice']?></td>
                            </tr>
                        <?php
                        }
                        ?>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td style="border-bottom:1px solid #000;"><?=$GetInvoices['DealerRemarks']?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom:1px solid #000; border-top:none !important;"><?=$GetInvoices['IMCRemarks']?></td>
                        </tr>
                        <tr>
                            <td style="border:none !important;">&nbsp;</td>
                            <td style="border-bottom:1px solid #000;">&nbsp;</td>
