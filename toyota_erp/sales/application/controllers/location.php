...
class Location extends CI_Controller {
    ...
    public function index() {
        ...
        $config['num_links'] = 1;
        $config["base_url"] = base_url() . "index.php/location/index";
        $config["total_rows"] = $this->Car_location->record_count();
        $config["per_page"] = 10;
        ...
        $this->data["Location"] = $this->Car_location->allLocation( $config["per_page"], $page);

        $this->data["counts"] = $this->Car_location->record_count();

        $this->data["links"] = $this->pagination->create_links();
        $this->data['message'] = $this->session->flashdata('message');
        //$Data = array();
        //$Location = new Car_location();
    ...
    function addlocation() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            redirect(base_url() . "index.php/location/index");
        }
    }
	...
	public function delete($id) {
      $LocationId=$id;
        $result = $this->Car_location->delete($LocationId);
		  redirect(base_url() . "index.php/location/index");
    }
