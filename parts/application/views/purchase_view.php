                                    ...
                                    <tbody id="finalResultLOC">
                                        ...
                                        foreach ($LOCPurchase as $row) {
                                            ...
                                            <tr id="carUsers">
                                                ...
                                                <td class="tbl-name" onclick='purchaseReturn("loc",<?= json_encode($row) ?>)'>Generate</td>
                                    ...
                                    <tbody id="finalResultIMC">
                                        ...
                                        foreach ($IMCPurchase as $InventoryPurchaseIMC) {
                                            ...
                                            <tr id="carUsers">
                                                ...
                                                <td class="tbl-name" onclick='purchaseReturn("imc",<?= json_encode($InventoryPurchaseIMC) ?>)'>Generate</td>
                ...
                if (a.length > 0) {
                    try {
                        ...
                        $.each(a, function(i, val) {
							...
							var loc = "loc";
							var url = '<?php echo site_url("purchase/generateLoc/")?>';
                            items += "<tr><td class='resId' name='resId'>" + count++ + "</td><td class='tbl - name'>" + val.PartNumber + "</td><td>" + val.PartName + "</td><td>" + val.CategoryName + "</td><td>" + val.PurchaseType + "</td><td>" + val.LandValue + "</td><td>" + val.PurchaseQuantity + "</td><td>" + val.PurchaseDate + "</td><td class='tbl-name' onclick='purchaseReturn(\"loc\","+JSON.stringify(val)+")'>" + 'Generate' +"</td><td class='tbl-name'><a href='"+url+"/"+val.idPurchase+"'>"+ 'Generate' + "</a></td></tr>";
                        });
                ...
                if (a.length > 0) {
                    try {
                        ...
                        $.each(a, function(i, val) {
							...
							var loc = "loc";
							var url = '<?php echo site_url("purchase/generateImc/")?>';
...
<td>" + val.QuantityReceived + "</td><td>" + val.LandValue + "</td><td>" + ((val.TotalCost == null) ? "" : val.TotalCost) + "</td><td>" + val.PurchaseDate + "</td><td class='tbl-name' onclick='purchaseReturn(\"imc\","+JSON.stringify(val)+")'>" + 'Generate' +"</td><td class='tbl-name'><a href='"+url+"/"+val.idPurchase+"'>"+ 'Generate' + "</a></td></tr>";
                        });
...
<td>" + val.PurchaseQuantity + "</td><td>" + val.PurchaseDate + "</td><td class='tbl-name' onclick='purchaseReturn(\"loc\","+JSON.stringify(val)+")'>" + 'Generate' +"</td><td class='tbl-name'><a href='"+url+"/"+val.idPurchase+"'>"+ 'Generate' + "</a></td></tr>";
                        });
                        $('#finalResultLOC').html(items);
                    } catch (e) {
                        console.log(e);
