    ...
    <div id="content">
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/documentreceive/receive_documents" class="form validate-form animated fadeIn">
                <div id="searchform" class="feildwrap">

                    <fieldset>
                        <legend>Documents Receiving</legend>

                        <br>
                        <input type="hidden" required name="status" id="status" value="Received">
                        <input type="hidden" required name="id" value="<?=$docs->id?>">
                        <input type="hidden" required name="type" value="<?=$docs->type?>">
                            ...
                            <?php foreach ($data as $row){
                                if($row['status']=='DISPATCHED') {
                                    ...
                                    <div>
                                        ...
                                        <input type="checkbox"
                                            <?= $row['status'] == 'DISPATCHED' ? 'checked' : '' ?>
                                            <?= $row['status'] == 'RECEIVED' ? 'checked' : '' ?>
                                               class="docs" name="iddocument[]" value="<?= $row['iddocument'] ?>"
                                               id="doc_<?= $row['iddocument'] ?>"/>
                                    </div>
