...
//print_r($_POST);
		...
		<?php //print_r($_POST);?>
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/parking/addlocation"
                  class="form validate-form animated fadeIn">
                <fieldset>
                    <legend>Add New Parking</legend>
                    <div class="feildwrap">
                        <div>
                            <label>Parking</label>
                     ...
                     <!--   <div>
                        ...
                        <div class="btn-block-wrap">
                            <label>&nbsp;</label>
                            <input type="submit" class="btn" value="Add New Parking">
                        </div>
                </fieldset>
            </form>
            <form method="post" class="form animated fadeIn">
                <fieldset>
                    <legend>Parking's List</legend>
                    <div class="feildwrap">
                    </div>
                        ...
                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tbody id="finalResult">
                                ...
                                foreach ($Location as $CarLocations) {
                                    ...
                                    <a href="<?=	base_url()."index.php/parking/delete/"  ?><?= $idLocation ?>">Delete</a>
...
<div style="width: 500px;" class="feildwrap  popup popup-detail">
    <form action="<?= base_url() ?>index.php/parking/update" method="POST" class="form animated fadeIn">
    ...
    <!--    <div>
        ...
        <div style="margin-left: 300px;">
            <input type="submit" class="btn" value="Update Parking">
        </div>
    </form>
</div>
<script>
