...
<script>
    $(document).ready(function(e) {
        ...
        $(document.body).on('click', ".error-vendors", function() {
            $(this).hide();
        });
        $(document.body).on('click', ".error-customers", function() {
            $(this).hide();
        });
        $(document.body).on('click', ".error-paymentmode", function() {
            $(this).hide();
        });
        $(document.body).on('click', ".error-vouchers", function() {
            $(this).hide();
        });
    });
    $(function() {
