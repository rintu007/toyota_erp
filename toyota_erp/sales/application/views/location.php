...
//        }
        ...
        <div class="right-pnel">
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/location/addlocation"
                ...
                <fieldset>
                    ...
                    <div class="feildwrap">
                        ...
                        <div class="btn-block-wrap">
                            <label>&nbsp;</label>
                            <input type="submit" class="btn" value="Add New Location">
                        </div>
                </fieldset>
            </form>
            <form method="post" class="form animated fadeIn">
                <fieldset>
                    <legend>Location's List</legend>
                    <div class="feildwrap">
                    </div>
                        ...
                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tbody id="finalResult">
                                ...
                                foreach ($Location as $CarLocations) {
                                    $idLocation = $CarLocations['idLocation'];
                                    ?>
                                    <tr id="rbRes">
                                        <td class="resId" name="resId"><?= $count++ ?></td>
                                        <td class="tbl-name"><?= $CarLocations['Location'] ?></td>
                                        <td class="tbl-name"><?= $CarLocations['Code'] ?></td>
                                        <td><a style="cursor: pointer;" onClick="LocationPopup('detail', '<?= $idLocation ?>', '<?= $CarLocations['Location'] ?>', '<?= $CarLocations['Code'] ?>')">Edit</a>
                                        </td>
										<td>
									
                                    <a href="<?=	base_url()."index.php/location/delete/"  ?><?= $idLocation ?>">Delete</a>
...
<div style="width: 500px;" class="feildwrap  popup popup-detail">
    <form action="<?= base_url() ?>index.php/location/update" method="POST" class="form animated fadeIn">
        ...
        <div style="margin-left: 300px;">
            <input type="submit" class="btn" value="Update Location">
        </div>
    </form>
</div>
<script>
    ...
    function LocationPopup(div_id, id, name, code) {
        $('.popup-' + div_id).bPopup({
