    ...
    <div id="content">
        ...
        <div class="right-pnel">
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>/index.php/AccessoriesOrder/saveAccessoriesOrder" class="form validate-form animated fadeIn">
                <fieldset>
                    ...
                    <div>
                        <br>
                        <input type="submit" class="btn" style="float: right;" value="Add Accessories Order">
                    </div>
                </fieldset>
            </form>
        </div>
