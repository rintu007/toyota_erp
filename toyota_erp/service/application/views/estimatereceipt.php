            ...
            <div class="col-xs-12">
                ...
                <div class="row clearfix">
                    <div class="col-xs-6">
                        ...
                        <span style="margin-left:12px;padding-left: 5px;width: 100px"><u class="uppercase"><?= $Estimate[0]['CustomerName'] ?></u></span>
                    </div>
					<div class="col-xs-6">
                        <span><b>Company Name:</b></span>
                       <span style="margin-left:12px;padding-left: 5px;width: 100px"><u class="uppercase"><?= $Estimate[0]['CompanyName'] ?></u></span>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-xs-6">
                        ...
                        <span style="margin-left:12px;padding-left: 5px;width: 100px"><u><?= $Estimate[0]['AddressDetails'] ?> & <?= $Estimate[0]['Cellphone'] ?></u></span>
                    </div>
					<div class="col-xs-6">
                ...
                <div class="row clearfix">
                    <div class="col-xs-6">
                        ...
                        <span style="margin-left:12px;padding-left: 5px;width: 100px"><U  class ="uppercase"><?= $Estimate[0]['Attender'] ?></U></span>
...
if($Estimate[0]['isMechanical'] == 1){
	...
	?>
		...
		<tr>
                        ...
                        <td class="amount"><?php $jjamount += (float)$r[1];echo number_format((float)$r[1], 2, '.', ''); ?></td>
...
?>
				<tr>
					...
					<tr>
                        <td colspan=7 align="left"  >  <?php $CI =& get_instance(); echo $CI->pm_package($Estimate[0]['PM_package']);?> </td>
...
if($Sublet){ ?>
				...
				<?php 	foreach($Sublet as $s){?>
					
					<tr>
                        <td colspan=7 align="eft" class="uppercase"><?= $s['Description']; ?> ( <?= $s['Quantity']; ?> )</td>
                    ...
                    <tr>
                        ...
                        <td class="amount"   ><b style="font-size:11px"><?php 
						   $totalAmount = 0;
...
$totalAmount = $jjamount;		 
	 ...
	 $totalAmount = $Estimate[0]['PM_amount'];
                            ...
                            echo number_format((float)($totalAmount+$totalAmount2), 2, '.', '') . " /=";?></b></td>
                    </tr>
                    </tbody>
                </table>
