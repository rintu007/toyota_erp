...
<div id="wrapper">
    <div id="content">
        <form action="<?= base_url() ?>/index.php/pbo/uploadPbo" onsubmit="return validationform()" enctype="multipart/form-data" method="post"
              class="form pbo-form fadeIn">
                  <?php
                    ...
                    <div class="feildwrap">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="text" name="nameofInvoice" id="nameofInvoice">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="NameOfIndividual" id="NameOfIndividual">
                            </div>
                            <div>
                                        ...
                                        <td>
                                            <select name="allocation_type" id="allocationType">
                                                ...
                                                foreach ($AllocationType as $Allocations) {
                                                    ...
                                                    ?>
                                                    <option value="<?= $Allocations['Id'] ?>" ><?= $Allocations['AllocationType'] ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
...
//                                                }
                                        ...
                                        <td>
                                            <select name="order_type">
                                                ...
                                                foreach ($OrderType as $OType) {
                                                    ...
                                                    ?>
                                                    <option value="<?= $OType['id'] ?>" ><?= $OType['OrderType'] ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <tr id="btwo">
                                     ...
                                     <!--  <tr id="rowtwo">
                                        <td>
                                            <label>Cheque Two</label>
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="ChequeTwo" id="ChequeTwo"/>
                                        </td>
                                    </tr>
                                     <tr id="btwo">
                                        <td>
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="BankTwo" id="ChequeOne"/>
                                        </td>
                                     ...
                                     <tr id="bntwo">
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="BranchTwo" id="ChequeOne"/>
                                        </td>
                                         
                                    </tr>
                                       <tr id="rowthree">
                                        <td>
                                            <label>Cheque Three</label>
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="ChequeThree" id="ChequeThree"/>
                                        </td>
                                    </tr>
                                     <tr id="bthree">
                                        <td>
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="BankThree" id="ChequeOne"/>
                                        </td>
                                     ...
                                     <tr id="bnthree">
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="BranchThree" id="ChequeOne"/>
                                        </td>
                                    ...
                                    <td id="opt">
                                        ...
                                        <!--    <label>Lassie</label>
                                            <input type="radio" name="OptL" id="Lassie" value="Lassie" style="float: left; height: 27px;"/> -->
                                    </td>
                                    <td>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="PboNumber" data-validation="required"/>
                                        ...
                                        <td>
                                            <input type="text" name="ActualSalePerson" value="<?php echo $ResourceBook['FullName']; ?>" readonly="readonly"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="OpeningDate" data-validation="required" class="date"/>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="ChasisNumber" id="comboChasisNo">
                                                <option value="">Select Chasis Number</option>
                                            </select>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="instrumenttype" name="instrumenttype[]">
                                                ...
                                                <option>Partial payment with WHT</option>
                                        ...
                                        <td>
                                            <input type="text" class="date" name="date[]"  placeholder="Date" style="width: 90px;"/>
                                        </td>
...
">
                                    <tr>
                                        ...
                                        <th ><input type="text" readonly name="TotalPartialAmount" value="0" id="total" ></th>
                                    </tr>
                                </table>
                            </div>
                        </fieldset>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr style="display: none">
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="efPayOrder" name="payOrderNo" style="margin-left: 10px;"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td>
                                            <input type="text" name="BankName" id="efBankName" />
                                        </td>
                                        <td>
                                            <label>Bank Branch</label>
                                        </td>
                                        <td>
                                            <input type="text" id="efBankBranch" name="BankBranch"/>
                                        </td>
                                    </tr>
                                    <tr style="display: none">
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="BankCity" id="efBankCity" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="amount" value="<?= $ResourceBook['TotalPrice'] ?>" id="amount"/>
                                        </td>
                                        <td>
                                            <label>In Words Ex Factory</label>
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="efAmountInWords" value="<?= convert_number_to_words($ResourceBook['TotalPrice']) ?>" id="efAmountInWords"/>
                                        </td>
                                    </tr>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="Filer" id="FIler" checked="true" value="Filer"/>
                                        </td>
                                        <td>
                                            <label>Non Filer</label>
                                        </td>
                                        <td>
                                            <input type="radio" name="Filer" id="NonFiler"  value="NonFiler"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td colspan="4">
                                            <input type="text" id="fiPayOrder" name="fiPayOrder"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="fiBankName" id="fiBankName" />
                                        </td>
                                        <td>
                                            <label>Bank Branch</label>
                                        </td>
                                        <td>
                                            <input type="text" id="fiBankBranch" name="fiBankBranch"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="fiBankCity" id="fiBankCity"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="wht">
                                        ...
                                        <td colspan="3">
                                    <!--        <input type="text" name="Freightamount" value="<?= $ResourceBook['FICharges'] ?>" id="Freightamount"/> -->
                                            <input type="text" name="Freightamount"  id="Freightamount" value="<?= $Filer['WHTFiler'] ?>" /> 
                                        </td>
                                        <td>
                                            <label>In Words WHT</label>
                                        </td>
                                        <td colspan="3">
                                            <input type="text" name="fiAmountInWords" value="<?= convert_number_to_words($Filer['WHTFiler']) ?>"/>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="date" name="PurchaseDate"/>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="feildwrap">
                                <table class="form-tbl">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="PboSerial" data-validation="required"/>
                                        </td>
                            ...
                            <tr style="display:none;">
                                ...
                                <td colspan="3">
                                    ...
                                    <input type="text" data-validation="required" name="variantId" value="<?= $ResourceBook['VehicleInterested'] ?>"
                                           readonly=""/>
<!--                                    <input type="text" data-validation="required" name="dMonth" value="<?= $ResourceBook['DeliveryMonth'] ?>"-->
                                    <!--readonly=""/>-->
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="custom-file-input" id="custom-file-input">
                                        ...
                                        <input type="file" id="uploaded" name="ImgPbo"/>
                        ...
                        <div style="margin-left: 380px;">
                            <input type="submit" class="btn" value="Generate PBO" style="width: 187px;">
                        </div>
                    </fieldset>
                ...
                if (a.length > 0) {
                    try {
                        ...
                        $.each(a, function (i, val) {
                            items += "<option value='" + val.Month + "'>" + val.Month + "</option>";
                        });
...
//            $("#efChasisNo").attr('disabled', false);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (a.length > 0) {
                        try {
                            var engine = "<option value=''>Select Engine Number</option>";
                            var chasis = "<option  value=''>Select Chasis Number</option>";
                            $.each(a, function (i, val) {
            ...
            if (OrderType == "Against Open Stock") {
            $('#efChasisNo').hide();
            $('#efEngineNo').hide();
            $('#comboChasisNo').show();
            $('#comboEngineNo').show();
...
//    }
        ...
        if (OrderType == 'Partial Payment')
        {
            $('.instrumenttype').html('')
             ...
             payment_dropdown =
                "                                            <select name=\"instrumenttype[]\">\n" +
                "                                                <option>Partial Payemnt with WHT</option>\n" +
                "                                                <option>Partial payment without WHT</option>\n" +
                "                                            </select>\n"
//            $("#rowone").show();
//            $("#rowtwo").show();
