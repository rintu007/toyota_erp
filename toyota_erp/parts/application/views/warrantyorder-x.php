        ...
        <div class="right-pnel">
            <form name="myform" onSubmit="return validationform()" method="post"
                ...
                <fieldset>
                    ...
                    <div>
                        <table id="do" title="Warranty Order" style="width:auto;height:auto;"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Warranty Order' ?>',required:true}}">Part Number</th>
                                    ...
                                    <th field="ModelCode" width="50" editor="{type:'validatebox',options:{required:false}}"> Model Code</th>
                                    <th field="FrameNo" width="50" editor="{type:'validatebox',options:{required:false}}">Frame #</th>
                                    <th field="TrNo" width="50" editor="{type:'validatebox',options:{required:false}}">TR #</th>
...
//                var value = elem.parentElement.parentElement.childNodes[1].innerHTML;
    ...
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/warrantyorder/allWarrantyorder',
        saveUrl: '<?= base_url() ?>/index.php/warrantyorder/saveWarrantyorder',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/warrantyorder/delete',
        ...
        $.each(row, function (index, value) {
            if (value) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/warrantyorder/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
