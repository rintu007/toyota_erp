    ...
    <body>
        ...
        <div id="printArea">
            ...
            <div class="container border" style="width: 948px;">
                ...
                <br/>
                <br/>
                <form action="<?= site_url("index.php/quotation/editprint")?>" method="post">
                    <div class="row">
                        <div class="span4">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['FullName']  ?>" name="FullName">  </span>
                                </div>
                            </div>
                        </div>
                        <div class="span8">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['BankName'] ?>" name="BankName"></span>
                                </div>
                            </div>
                        </div>
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    <span>TWM/ <input type="text"
                                                      value="<?= date('Y') ?>/<?= $Quotation[0]['IdResourceBook'] ?>" name="IdResourceBook"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    <span><input type="text" value="<?= $Quotation[0]['Date'] ?>" name="Date"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text"
                                                 value="<?= $Quotation[0]['CustomerName'] . " " . $Quotation[0]['FatherName'] ?>" name="FatherName"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table" style="width: 90%;margin: auto;">
                                ...
                                foreach ($Quotation as $quotation) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?= $quotation['Variants'] ?>" name="Variants"></td>
                                        <td style="text-align: center;">1</td>
                                        <td style="text-align: center;"><input type="text"
                                                                               value="<?= $quotation['Price'] ?>" name="Price"></td>
                                        <td style="text-align: right;"><input type="text"
                                                                              value="<?= $quotation['TotalPrice'] ?>" name="TotalPrice">
                                        </td>
                                    </tr>
                                    <?php
                                }
                    ...
                    <div class="row">
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['DisplacementName'] ?>" name="DisplacementName"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['Model'] ?>" name="Model"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['ColorName'] ?>" name="ColorName"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span8">
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <span><input type="text" value="<?= $Quotation[0]['DeliveryMonth'] ?>" name="DeliveryMonth"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                    <input type="submit" value="Print"  class="btn-primary">
                    </div>
                </form>
