...
//print_r($_POST);
		...
		<?php //print_r($_POST);?>
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/headings/addlocation"
                  class="form validate-form animated fadeIn">
                <fieldset>
                    <legend>Add New headings</legend>
                    <div class="feildwrap">
                        <div>
                     ...
                     <!--   <div>
                        ...
                        <div class="btn-block-wrap">
                            <label>&nbsp;</label>
                            <input type="submit" class="btn" value="Add New headings">
                        </div>
                </fieldset>
            </form>
            <form method="post" class="form animated fadeIn">
                <fieldset>
                    <legend>headings's List</legend>
                    <div class="feildwrap">
                    </div>
                            ...
                            <tbody id="finalResult">
                                ...
                                foreach ($Location as $CarLocations) {
                                    ...
                                    <tr id="rbRes">
                                        ...
                                        <td class="tbl-name"><?= $CarLocations['heading'] ?></td>
                                    <!-- <td class="tbl-name"><?= $CarLocations['Code'] ?></td> -->
                                        <td><a style="cursor: pointer;" onClick="LocationPopup('detail', '<?= $idLocation ?>', '<?= $CarLocations['heading'] ?>')">Edit</a>
                                        </td> 
										<td>
									
                                    <a href="<?=	base_url()."index.php/headings/delete/"  ?><?= $idLocation ?>">Delete</a>
...
<div style="width: 500px;" class="feildwrap  popup popup-detail">
    <form action="<?= base_url() ?>index.php/headings/update" method="POST" class="form animated fadeIn">
    ...
    <!--    <div>
        ...
        <div style="margin-left: 300px;">
            <input type="submit" class="btn" value="Update headings">
        </div>
    </form>
</div>
<script>
