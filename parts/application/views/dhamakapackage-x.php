...
//                        
                    ...
                    <div>
                        <table id="do" title="Dhamka Package" style="width:auto;height:auto;"
                               url="<?= base_url() ?>/index.php/invoices/searchdhamakapackage/" toolbar="#toolbar" pagination="true" idField="OrderNumber"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'Dhamaka Package' ?>',required:true}}">Part Number</th>
...
<script>
    ...
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/dhamakapackage/allDhamkapackage',
        saveUrl: '<?= base_url() ?>/index.php/dhamakapackage/saveDhamkapackage',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/dhamakapackage/delete',
        ...
        $.each(row, function (index, value) {
            if (row) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/dhamakapackage/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
