...
//            include 'include/leftmenu.php';
        ...
        <div class="right-pnel">
            <form id="partsrequisitionmechform" action="<?= base_url() ?>index.php/partsrequisitionmechanical/Add"  method="post" onSubmit="return validationform()" class="form animated fadeIn">
                <h4><?= $insertMessage ?></h4>
                <fieldset>
                            ...
                            <div class="feildwrap"> 
                                ...
                                <div> 
                                   <!-- <label>Parts Department</label>-->
                                    <input id ="PartsDepartment" name="PartsDepartment" type="hidden" placeholder="Signature">
                                </div>
...
<script>
    ...
    $("#newRow").click(function(e) {
        ...
        $("select[name='MechPartsName[]']").chosen({no_results_text: "Oops, nothing found!"});
        $("select[name='MechParts[]']").chosen({no_results_text: "Oops, nothing found!"});
    ...
    $("#RoNumber").focusout(function() {
        ...
        $.ajax({
            url: "<?= base_url() ?>index.php/Partsrequisitionmechanical/searchRONumber",
            type: "POST",
...
//                            $(Source).closest('td').next('td').next('td').next('td').find('input').val();
    ...
    function deleteRow(r) {
        ...
        document.getElementById('MPartReqTable').deleteRow(i);
    }

    function validationform() {
        var countPartRows = $("#MPartReqTable > tbody").children().length;
        var isValidate = 1;

        if (countPartRows > 0) {
            $('#newRow').val('-');
            var selects = $("#MPartReqTable").find(".slctboxes");
