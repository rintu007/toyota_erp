...
//                        
                    ...
                    <div>
                        <table id="do" title="VOR" style="width:auto;height:auto;"
                               url="<?= base_url() ?>/index.php/invoices/searchvor/" toolbar="#toolbar" pagination="true" idField="OrderNumber"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th field="PartNumber" width="60" editor="{type:'combobox',options:{valueField:'PartNumber', textField:'PartNumber', url:'<?= base_url() ?>/index.php/invoices/parts/<?= 'VOR' ?>',required:true}}">Part Number</th>
                                    ...
                                    <th field="FrameNo" width="50" editor="{type:'validatebox',options:{required:false}}">Frame No</th>
...
<script>
    $('#do').edatagrid({
        url: '<?= base_url() ?>/index.php/VOR/allVOR',
        saveUrl: '<?= base_url() ?>/index.php/VOR/saveVOR',
        updateUrl: '<?= base_url() ?>/index.php/parts/edit',
        destroyUrl: '<?= base_url() ?>/index.php/VOR/delete',
        ...
        $.each(row, function (index, value) {
            if (value) {
                $.messager.confirm('Confirm', 'Are you sure you want to delete this order?', function (r) {
                    if (r) {
                        $.post('<?= base_url() ?>/index.php/VOR/delete', {id: value.OrderNumber}, function (result) {
                            window.res = result;
                            if (result.success) {
