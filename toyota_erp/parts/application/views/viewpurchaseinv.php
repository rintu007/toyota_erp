...
<script type="text/javascript">
        ...
        function PrintDoc() {
            ...
            popupWin.document.write('<html><title>::Preview::</title><link rel=Stylesheet href=<?= base_url(); ?>assets/bootstrap/css/custom1.css><link rel=Stylesheet href=<?= base_url(); ?>assets/css/stylesheet.css></head><body onload="window.print()">');
        ...
        function PrintPreview() {
            ...
            popupWin.document.open();
            popupWin.document.write('<html><title>::Print Preview::</title><link rel=Stylesheet href=<?= base_url(); ?>assets/bootstrap/css/custom1.css><link rel=Stylesheet href=<?= base_url(); ?>assets/css/stylesheet.css></head><body>');
            popupWin.document.write(toPrint.innerHTML);
            popupWin.document.write('</html>');
            popupWin.document.close();
        }
...
<div id="ImcPurchase" class="container border" style="width: 948px;">
  ...
  <div class="table-responsive border-none">
    ...
    <div class="half-width" style="text-align:right;"><strong>IMC Detail&nbsp:(Imported Parts)</strong></div>
    <table class="table">
      <tbody>
      <td class="invio_left_td"> Customer Code : <strong>
          <?=  sprintf($PurchaseInvoice[0]['idPartCustomer'])  ?>
          </strong></td>
      ...
      <tr>
        <td class="invio_left_td">Customer Name : <strong>
          <?=  sprintf($PurchaseInvoice[0]['CustomerName'])  ?>
          <? ?>
          </strong></td>
      ...
      <tr>
        <td class="invio_left_td">Address :<br><strong>
          <?=  sprintf($PurchaseInvoice[0]['Address'])?></strong></td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="invoi_right_td">Order No. :
          <strong><?=  sprintf($PurchaseInvoice[0]['Number']) ?></strong></td>
      </tr>
      <tr>
        <td class="invio_left_td">PO Number : <strong>
          <?=  sprintf($PurchaseInvoice[0]['OrderNo'])  ?>
          </strong></td>
        <td class="invoi_right_td">Order Date :
          <strong><?=  sprintf($PurchaseInvoice[0]['Date']) ?></strong>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td class="invio_left_td">PO Date : 
          <strong><?=  sprintf($PurchaseInvoice[0]['Date']) ?></strong>
		  </td>
        <td class="invoi_right_td">Ord. Reason : 
          <strong><?=  sprintf($PurchaseInvoice[0]['DealerRemarks']) ?></strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <div class="span12 text-center"> 
	  ...
	  <tbody>
             <?php
										...
										for($i=1;$i <= $count1;$i++)
										{
											array_push($TotalSaletax,  17 / 100 * $PurchaseInvoice[$i-1]['TotalCost']);
										}
										for($i=1;$i <= $count1;$i++)
										{
											array_push($TotalSaletax1,  2 / 100 * $PurchaseInvoice[$i-1]['TotalCost']);
										}
										for($i=1;$i <= $count1;$i++)
										{
											array_push($TotalSaletax2,  1 / 100 * $PurchaseInvoice[$i-1]['TotalCost']);
										}
										for($i=1;$i <= $count1;$i++)
										{
										...
										for($i=1;$i <= $count1;$i++)
										{
											array_push($TNetvalue,  $PurchaseInvoice[$i-1]['TotalCost']);
										}
                                        ...
                                        foreach ($PurchaseInvoice as $InventoryPurchase) {
                                           if($InventoryPurchase['QuantityReceived']!=0 && $InventoryPurchase['TotalCost']!=0){
                                            $InventoryId = $InventoryPurchase['idPurchase'];
											//var_dump($InventoryIdIMC);
											$saletax1 =17 / 100 * $InventoryPurchase['TotalCost'];
											$saletax2 =2 / 100 * $InventoryPurchase['TotalCost'];
											$saletax3 =1 / 100 * $InventoryPurchase['TotalCost'];
                                            ?>
                                            <tr id="carUsers">
                                                <td class="resId" name="resId"><?= $count++ ?></td>
                                                <td class="tbl-name"><?= $InventoryPurchase['PartNumber']?></td>
                                                <td class="tbl-name"><?= $InventoryPurchase['Description'] ?></td>
                                                <td class="tbl-name"><?= $InventoryPurchase['QuantityReceived'] ?></td>
                                                <td class="tbl-name"><?= $InventoryPurchase['TotalCost'] ?></td>
                                                <td class="tbl-name"><?= $InventoryPurchase['TotalCost'] ?></td>
                                                ...
                                                <td class="tbl-name"><?= ($InventoryPurchase['TotalCost'] + $saletax1 + $saletax2 + $saletax3) ?></td>
  ...
  <div class="row-fluid">
    ...
    <div class="gray-bg " style="text-align:center; display: table;width: 100%;"><strong>This is computer generated invoice and do not require any stamp or signature</strong></div>
    <div class="footer-bottom">
        <div class="footer-info">
            <strong>Head Office </strong> 
            <p> :&nbsp; Factory/Registered Office: Plot No: N.W.Z./P-1, Port Qasim Authority, Karachi. Phones:(92-21)34720041-48Fax:(92-21) 34720037</p></div>
      <div class="footer-info">  
          <strong>Islamabad Office </strong>
          
          <p> :&nbsp; 1-b 1st floor, Awan Arcade,Nazimuddin Road, Islamabad. Phones:(92-51) 2810300-01, Fax:(92-51) 2810302</p></div>
      <div class="footer-info">  
          <strong>Lahore Office  </strong>
          
          <p>:&nbsp; 9Z, Commercial Area, Phase III, DHA Lahore Cantt.Phones: (92-42) 35743580-81, Fax: (92-42) 35743582</p></div>
    </div>
  </div>
</div>
</body>
