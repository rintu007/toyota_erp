 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Toyota Western Motors');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Toyota Western Motors');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Toyota Western Motors');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Customer Relations Reports");
