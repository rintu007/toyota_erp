...
//        }
        ...
        <div class="right-pnel">
            ...
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/parts/newPart" class="form validate-form animated fadeIn">
                <fieldset>
                    <legend>Add Part</legend>
                    <div class="feildwrap">
                        <div>
                            <label>Part Number</label>
                            <input type="text" name="PartId" data-validation="required" id="PartId">
                        </div>
                        <div>
                            <label>Part Name</label>
                            <input type="text" name="PartName" data-validation="required" id="PartName">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="CostPrice" data-validation="number">
                        </div>
                        <div>
                            <label>Retail Price</label>
                            <input type="text" name="RetailPrice" data-validation="number">
                        </div>
                        <div>
                            <label>MAD</label>
                            <input type="text" name="Mad" >
                        </div>
                        <div>
                            <label>MIP</label>
                        ...
                        <div>
                            ...
                            <select id="pLocation" name="sLocation">
                        ...
                        <div>
                            ...
                            <input type="text" name="OrderCycle">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="PhaseOutQuantity">
                        </div>
                        <div>
                            <label>Part Description</label>
                            <textarea name="Description" style="margin: 0px; width: 512px; height: 100px;">
                            </textarea>
                        </div>
                    </div>
                </fieldset>
                ...
                <div class="btn-block-wrap">
                    <label>&nbsp;</label>
                    <input type="submit" class="btn" value="Add Part" style="margin-left: 460px;width: 180px;">
                </div>
            </form>
        </div>
    </div>
    ...
    $("input[name=ModelName]").keyup(function(e) {
        ...
        $("#PartId").keyup(function() {
             var id = $('#PartId').val();
                ...
                $.ajax({
                url: "<?php echo base_url(); ?>index.php/parts/checkPart",
                type: "POST",
                data: {id: id},
                success: function(data) {
                    if (data !== "null")
