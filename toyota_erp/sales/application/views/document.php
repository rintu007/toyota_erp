...
//print_r($_POST);
		...
		<?php //print_r($_POST);?>
            <form name="myform" onSubmit="return validationform()" method="post"
                  action="<?= base_url() ?>index.php/document/addlocation"
                    ...
                    <div class="feildwrap">
                     ...
                     <!--   <div>
                        ...
                        <div class="btn-block-wrap">
                            <label>&nbsp;</label>
                            <input type="submit" class="btn" value="Add New document">
                        </div>
                </fieldset>
            </form>
            <form method="post" class="form animated fadeIn">
                <fieldset>
                    <legend>document's List</legend>
                    <div class="feildwrap">
                    </div>
                        ...
                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tbody id="finalResult">
                                ...
                                foreach ($Location as $CarLocations) {
                                    $idLocation = $CarLocations['iddocument'];
                                    ?>
                                    <tr id="rbRes">
                                        <td class="resId" name="resId"><?= $count++ ?></td>
                                        <td class="tbl-name"><?= $CarLocations['documentname'] ?></td>
                                    <!-- <td class="tbl-name"><?= $CarLocations['Code'] ?></td> -->
                                        <td><a style="cursor: pointer;" onClick="LocationPopup('detail', '<?= $idLocation ?>', '<?= $CarLocations['documentname'] ?>')">Edit</a>
                                        </td> 
										<td>
									
<!--                                    <a href="--><?//=	base_url()."index.php/document/delete/"  ?><!----><?//= $idLocation ?><!--">Delete</a>-->
...
<div style="width: 500px;" class="feildwrap  popup popup-detail">
    <form action="<?= base_url() ?>index.php/document/update" method="POST" class="form animated fadeIn">
    ...
    <!--    <div>
        ...
        <div style="margin-left: 300px;">
            <input type="submit" class="btn" value="Update document">
        </div>
    </form>
</div>
<script>
