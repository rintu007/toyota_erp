...
//        }s
        ...
        <div class="right-pnel">
            <form method="post" target="_blank" class="form animated fadeIn" action="<?= base_url() ?>/index.php/reports/order">
                <fieldset>
                    ...
                    <div class="feildwrap">
                        ...
                        <!--</div>-->
                        <div>
                            <label>Search By Order Mode</label>
                            <select name="OrderMode">
                                <option>Select Order Mode</option>
                                <?php
                                foreach ($OrderMode as $AllOrderMode) {
                                    ?>
                                    <option value="<?= $AllOrderMode['id'] ?>" ><?= $AllOrderMode['Title'] ?></option>
                                    <?php
                                }
                                ?>
                            </select>
